...
public class TimeUnitUtils {
    ...
    /**
     * Конвертирует интервал в миллисекундах в интервал в минуты
     *
     * @param millis интервал в миллисекундах
    ...
    /**
     * Конвертирует интервал в миллисекундах в интервал в часы
     *
     * @param millis интервал в миллисекундах
    ...
    /**
     * Конвертирует интервал в секундах в интервал в миллисекунды
     *
    ...
    /**
     * Конвертирует интервал в секундах в интервал в минуты
     *
     * @param seconds интервал в секундах
     * @return интервал в минутах
     */
    ...
    /**
     * Конвертирует интервал в секундах в интервал в часы
     *
     * @param seconds интервал в секундах
     * @return интервал в часах
     */
