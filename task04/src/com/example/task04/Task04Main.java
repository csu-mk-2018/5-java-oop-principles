...
public class Task04Main {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        logger1.addHandler(new MemoryHandler(new FileHandler("C:/Users/Admin/Desktop/javalog/mem.txt"), 5));
        logger1.addHandler(new RotationFileHandler("C:/Users/Admin/Desktop/javalog/rfh", "yyyy_MM_dd_hh_mm", ChronoUnit.MINUTES));
        ...
        logger1.addHandler(new FileHandler("C:/Users/Admin/Desktop/javalog/fh.txt"));
